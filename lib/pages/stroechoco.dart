...
class chocoDetails extends StatefulWidget {
  @override
  _chocoDetails createState() => new _chocoDetails();
}

class _chocoDetails extends State<chocoDetails> {
  int _current = 0;
  String isfav = '0';
  List<String> imagess = [
    'assets/choco.jpg',
